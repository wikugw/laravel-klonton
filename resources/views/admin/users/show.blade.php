            ...
            <div class="profile-content-left profile-left-spacing pt-5 pb-3 px-3 px-xl-5">
                <div class="card text-center widget-profile px-0 border-0">
                    <div class="card-img mx-auto rounded-circle">
                        ...
                        @else
                        <img src="{{url($user->profile_photo)}}" alt="profile toko" height="100%">
                        @endif
                    </div>
                    <div class="card-body">
        ...
        <div class="col-lg-8 col-xl-9">
            <div class="profile-content-right profile-right-spacing py-5">
                <ul class="nav nav-tabs px-3 px-xl-5 nav-style-border" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="settings-tab" data-toggle="tab" href="#settings" role="tab" aria-controls="settings" aria-selected="false">Edit Biodata</a>
                    </li>
                </ul>
...
<div class="tab-pane-content mt-5">
  ...
  <div class="form-group mb-4">
    ...
    <input type="number" class="form-control" name="phone_number" id="email" value="{{ $user->phone_number }}">
    <span class="d-block mt-1">* Wajib diisi</span>
  </div>
